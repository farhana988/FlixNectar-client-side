...
const Update = () => {
    ...
    const {_id, photo, name, genre, duration, releaseYear, summary,rating: movieRating} = movie;

      // Setting the initial state with the movie data
      const [selectedDate, setSelectedDate] = useState(new Date(releaseYear)); // changed from null to the actual release year as Date
      const [rating, setRating] = useState(movieRating || 0); // changed to use movieRating as default
    ...
    const handleDateChange = (date) => {
      ...
      const handleUpdate = (e) => {
        ...
        const updatedMovie = { photo, name, genre, duration, releaseYear, rating, summary }
